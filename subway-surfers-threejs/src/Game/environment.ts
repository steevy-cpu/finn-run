...
export default class Environment {
    ...
    coin: THREE.Object3D[] = [];
    // One group per road section (same index as plane/obstacal/coin).
    sections: (THREE.Group | null)[] = [];
    z!: number;
    house1Scene: any;
    house2Scene: any;
    house3Scene: any;
    ...
    // and the game starts to hitch after a few minutes.
    pruneBehind(currentPlane: number) {
        for (let i = 0; i < currentPlane - 1; i++) {
            ...
            this.obstacal[i] = null as any;
            this.coin[i] = null as any;
        }
    }
    // 设置环境光
    setAmbientLight() {
